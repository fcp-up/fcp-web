...
import com.defu.fcp.atom.service.ISvcAdmindiv;
 ...
 * }</pre>
 */
@RequestMapping(value = "admindiv")
public class ActAdmindiv extends AbstractAction {
	@Autowired protected ISvcAdmindiv svc;
